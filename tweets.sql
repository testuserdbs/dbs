...
ALTER TABLE hat_einen ADD CONSTRAINT hat_einen_fk FOREIGN KEY (h_name) REFERENCES hashtag (h_name);
ALTER TABLE hat_einen ADD CONSTRAINT hat_einen_fk FOREIGN KEY (tweet_id) REFERENCES tweet (tweet_id);
# dbs
