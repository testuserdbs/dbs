CREATE TABLE tweet(tweet_id int NOT NULL, favorite_count int, retweet_count int, t_time timestamp with time zone, text varchar, CONSTRAINT tweet_pk PRIMARY KEY (tweet_id) );
